...
<head>
  ...
  <div class="container-fluid">
    ...
    <img src="../images/avatar.png" class="avatar">
        ...
        <form name="Registration" action="faculty_signup.php" method="POST">
        ...
        <p>Firstname</p>
          ...
          <p>Username</p>
            ...
            <br>
            <p>
            Already a user? &nbsp<a href="faculty_login.php">Log In</a>
            </p>
        </form>
...
if(isset($_POST["submit"]))
 ...
 if($count==0)
 {
 mysqli_query($db,"INSERT INTO `admin` VALUES('$_POST[first]','$_POST[last]','$_POST[username]','$_POST[password]','$_POST[email]','user.png');");
