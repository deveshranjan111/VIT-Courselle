  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="about.php" class="page-scroll" >About<span class="sr-only">(current)</span></a></li>
           ...
           <div class="row">
               <div class="col-lg-12 text-center">
                  <h2 class="section-heading">About</h2>
                    <h3 class="section-subheading text-muted">All you want to know about us.</h3>
                   </div>
           </div>
           <div class="row text-center">
                <div class="col-md-8">
                    <h2>It All Started in the Classroom</h2>
                    <p>There was a need of a online project management among the faculties of our institute.This lead to the idea of making a schoology type website which can create courses and add students to it with their username and can take the submission of assigments and hence faculty can evaluate it.It has lots of features of adding students in a course and has deadline to the submission of assigment with mail sending facility.Quiz can also be organized in this website easily with itself evaluating and publising result.It has login and signup for both instructor and student.It also has contact us page to contact us .You can also contact us through facebook,instagram and twitter.</p>
                </div>
                <div class="col-md-4">
                    
                    <h3>Work made easy</h3>
                    <p>It took around 4-5 months to make this website.we had a team of 2 peoples.We made frontend using HTML,CSS ,javascript,Jquery,Bootstrap.Backend part was done using PHP and database using mySQL.It is a very fast working website with runs with all the latest technologies.</p>
                </div>
            </div>
        </div>
    </section>
