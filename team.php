  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="features.php" class="page-scroll" >Features<span class="sr-only">(current)</span></a></li>
        <li class="active"><a href="team.php" class="page-scroll">Team</a></li> 
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Developer and designing team members</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="team-member">
                        <img src="images/image2.jpg" class="img-responsive img-circle" alt="">
                        <h4>Devesh Ranjan</h4>
                ...
                <div class="col-sm-6">
                    <div class="team-member">
                        <img src="images/4.jpg" class="img-responsive img-circle" alt="">
                        <h4>N.S.S.VARMA</h4>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <p class="large text-muted">Meet our amazing team who all developed this great website from scratch .All the front end work and and backend work done by our developers.</p>
                </div>
            </div>
        </div>
    </section>
